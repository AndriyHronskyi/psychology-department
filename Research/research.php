...
<html>
<head>
    <?php     styleSheetConnect('Наукові дослідження','research.css');?>  
</head>
<body>
    <div class="Main">
        <?php //header
        ...
        <div class="container-1">
            <div class="box-1" id="sidebar">
                <?php Sidebar(6,1,$db); //(number of active element on menu , 1-specialist widet ON, connection)?>
            </div>
            <div class="box-2">
                <div class="box-title">
                ...
                <div class="nContainer">
                    ...
                    <?
                    $ph = mysqli_query($db, "SELECT * FROM research ORDER BY research.id DESC");
